---
title:         "3.8 - Injection SQL (défense)"
description:   "Contrôler les requêtes à la base de données"
...
## Temps pour le TP / Correctif sur le code fourni
