...
STRING powershell -enc LgBcAE0AZQBjAGgAYQBuAHQAUwBjAHIAaQBwAHQALgBwAHMAMQA=
...
2. Décoder la charge utile PowerShell encodée en UTF-16LE Base64 (`LgBcAE0AZQBjAGgAYQBuAHQAUwBjAHIAaQBwAHQALgBwAHMAMQA=`) avec [ce décodeur Base64](https://www.base64decode.org) pour obtenir le **texte_décodé**
